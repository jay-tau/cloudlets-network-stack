...
#include <iostream>
#include <vector>
#include <fstream> // Added include for file handling
#include <cmath>
 ...
 * \brief Test script.
 *
 * This script creates 1-dimensional grid topology and then ping the last node from the first one:
 *
 * [10.0.0.1] <-- step --> [10.0.0.2] <-- step --> [10.0.0.3] <-- step --> [10.0.0.4]
 *
 * ping 10.0.0.4
 *
 * When 1/3 of the simulation time has elapsed, one of the nodes is moved out of
